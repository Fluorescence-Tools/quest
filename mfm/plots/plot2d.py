...
class SurfacePlotWidget(QtGui.QWidget):
    def __init__(self, parent=None):
        self.xmin = ParameterWidget('', 0.0, model=parent, hide_fix_checkbox=True, hide_link=True)
        self.xmax = ParameterWidget('', 0.0, model=parent, hide_fix_checkbox=True, hide_link=True)
        self.ymin = ParameterWidget('', 0.0, model=parent, hide_fix_checkbox=True, hide_link=True)
        self.ymax = ParameterWidget('', 0.0, model=parent, hide_fix_checkbox=True, hide_link=True)
