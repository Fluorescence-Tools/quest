...
from lib.fluorescence.fps.dynamic import Sticking, Dye, ProteinQuenching, DiffusionSimulationParameter, DiffusionSimulation
...
parser.add_argument('-f', metavar='pdb_file', type=str, help='The pdb file used', required=True)
parser.add_argument('-c', metavar='chain_id', type=str, help='The chain id.', required=True)
parser.add_argument('-p', metavar='labeling_positions', type=int, help='The residue numbers of the amino acids to be labeled.', nargs='+', required=True)
