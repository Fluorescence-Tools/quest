...
import mfm
from mfm.fluorescence.simulation import _photon
...
def simulate_photon_trace_rate(n_ph, quench, t_step=0.01, tau0=4.10, n_traj=4, **kwargs):
    ...
    for i in range(n_traj):
        ...
        _photon.simulate_photons(dts_i, phs_i, n_ph, quench, t_step, tau0, n_traj, rand_shift_i)
...
def simulate_decay_quench(n_curves, decay, dt_tac, k_quench, t_step, tau0, **kwargs):
    ...
    _photon.simulate_decay(n_curves=n_curves,
                           decay=decay,
                           dt_tac=dt_tac,
                           k_quench=k_quench,
                           t_step=t_step,
