...
ne.set_num_threads(mfm.n_threads)
...
def simulate_traj_point(d, ds, dg, t_max, t_step, diffusion_coefficient, slow_fact):
    """
...
class DiffusionSimulationParameter(AggregatedParameters):
    ...
    def __init__(self, t_max=2000, t_step=0.05, n_simulations=4):
        ...
        self._t_max = Parameter(value=t_max, name='t-max')
        self._t_step = Parameter(value=t_step, name='t-step')
...
class DiffusionSimulation(object):
    ...
    def update(self, **kwargs):
        ...
        diffusion_coefficient = kwargs.get('diffusion_coefficient', self.dye.diffusion_coefficient)
        ...
        av = self.dye.get_av()
        self._av = av
        traj, a, n_accepted, n_rejected = simulate_traj_point(av.density,
                                                              av.density_slow,
                                                              av.dg,
                                                              slow_fact=slow_fact,
                                                              t_step=t_step,
        ...
        collided = np.empty((quencher_xyz.shape[0], dye_xyz.shape[0]), dtype=np.uint8)
        a = self.dye.critical_distance
        for i, quencher_position in enumerate(quencher_xyz):
            dist = ne.evaluate("sum((dye_xyz - quencher_position)**2, axis=1)")
            collided[i] = np.less(dist, a**2)
...
class Dye(AggregatedParameters):
    ...
    def simulation_grid_resolution(self, v):
        self._simulation_grid_resolution.set_value(v)
    ...
    def diffusion_coefficient(self, v):
        self._diffusion_coefficient.set_value(v)
    ...
    def critical_distance(self, v):
        self._critical_distance.set_value(v)
    ...
    def get_av(self, **kwargs):
        ...
        av = mfm.fluorescence.fps.AV(structure=structure,
                                     ...
                                     save_av=False,
                                     **self.av_parameter)
        av.calc_slow_av(slow_centers=sticking.slow_center,
    ...
    def __init__(self, sticking, **kwargs):
        ...
        self._critical_distance = Parameter(7.0, name='RQ')
        self._diffusion_coefficient = Parameter(5.0, name='D[A2/ns]')
        self._tau0 = Parameter(4.0, name='tau0[ns]')
        self._simulation_grid_resolution = Parameter(0.5, name='grid spacing')

        self._av_length = Parameter(name='L', value=20.0)
        self._av_width = Parameter(name='W', value=0.5)
        self._av_radius = Parameter(name='R', value=3.0)
...
class Sticking(AggregatedParameters):
    ...
    def __init__(self, structure, quenching_parameter=None, **kwargs):
        ...
        self.model = kwargs.get('model', None)
        self._slow_radius = Parameter(name='Rs', value=kwargs.get('slow_radius', 8.5))
        self._slow_fact = Parameter(name='slow fact', value=kwargs.get('slow_fact', 0.1))
...
class ProteinQuenching(AggregatedParameters):
    ...
    @kQ_scale.setter
    def kQ_scale(self, v):
        self._k_quench_scale.set_value(v)
    ...
    def __init__(self, structure, **kwargs):
        ...
        self._k_quench_scale = Parameter(value=kwargs.get('quench_scale', 0.01), name='kQ scale')
...
class ProteinQuenchingWidget(ProteinQuenching, QtGui.QGroupBox):
    ...
    def __init__(self, **kwargs):
        ...
        self.quencher = kwargs.get('quenching_amino_acids',
                                   {'TRP': ['CB'], 'TYR': ['CB'], 'HIS': ['CB']})
        self._k_quench_scale = ParameterWidget(value=kwargs.get('k_quench_protein', 5.0),
...
class DyeWidget(Dye, QtGui.QGroupBox):
    ...
    def __init__(self, **kwargs):
        ...
        self._critical_distance = ParameterWidget(value=7.0, name='RQ', digits=1, model=self.model)
        self._diffusion_coefficient = ParameterWidget(value=5.0, name='D[A2/ns]', digits=1, model=self.model)
        self._tau0 = ParameterWidget(value=4.0, name='tau0[ns]', digits=2, model=self.model)

        self._av_length = ParameterWidget('L', 20.0, digits=1, model=self.model)
        self._av_width = ParameterWidget('W', 0.5, digits=1, model=self.model)
        self._av_radius = ParameterWidget('R', 5.0, digits=1, model=self.model)
...
class StickingWidget(Sticking, QtGui.QGroupBox):
    ...
    def __init__(self, **kwargs):
        ...
        self._slow_radius = ParameterWidget('Rs[A]', 10.0, digits=1, model=self.model)
        self._slow_fact = ParameterWidget('slow fact', 0.15, digits=3, model=self.model)
