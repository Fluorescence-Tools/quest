...
class PDB2Label(QtGui.QWidget):
    ...
    def onLoadReferencePDB(self):
        ...
        self.structure = mfm.Structure(self.pdb_filename)
        self.atom_select.atoms = self.structure.atoms

    def onAddLabel(self):
        label = {
            "atom_name": self.atom_select.atom_name,
            "chain_identifier": self.atom_select.chain_id,
            "residue_seq_number": self.atom_select.residue_id,
            "residue_name": self.atom_select.residue_name,
            "attachment_atom_index": self.atom_select.atom_number,
            "simulation_type": self.simulation_type,
            "linker_length": self.av_properties.linker_length,
            "linker_width": self.av_properties.linker_width,
            "radius1": self.av_properties.radius_1,
            "radius2": self.av_properties.radius_2,
            "radius3": self.av_properties.radius_3,
            "simulation_grid_resolution": self.av_properties.resolution
        }
