...
from mfm.structure import cStructure
...
class Structure(mfm.Data):
    ...
    >>> import mfm
    >>> s_coarse = mfm.Structure('/sample_data/structure/HM_1FN5_Naming.pdb', verbose=True, make_coarse=True)
    ======================================
    ...
    >>> s_aa = mfm.Structure('/sample_data/structure/HM_1FN5_Naming.pdb', verbose=True, make_coarse=False)
    >>> print s_aa
    ...
    def __init__(self, filename=None, make_coarse=False, verbose=False, auto_update=True):

        mfm.Data.__init__(self)
        ...
        if filename is not None:
            ...
            ######         PREPARE   COORDINATES          ######
            ####################################################
            self._atoms = self.io.read(filename, verbose=self.verbose)
    ...
    def write(self, filename=None, append_model=False, append_coordinates=False):
        """
